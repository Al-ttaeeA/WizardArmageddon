...
public class Data {
    ...
    public final static Spell[] spells = {
        ...
        new Spell("Lesser Sun beam"     , 380, 10, 0.33, "[Fire]"),
        new Spell("Meteor Rain"         , 90 , 40, 0.36, "[Fire]"),
        new Spell("Inferno Blaze"       , 130, 30, 0.20, "[Fire]"),
        new Spell("Flame Thrower"       , 200, 15, 0.22, "[Fire]"),
        new Spell("Fire Tornado"        , 300, 20, 0.38, "[Fire]"),
        new Spell("Fireball Cluster"    , 100, 40, 0.39, "[Fire]"),
        ...
        new Spell("Sand Tornado"        , 200, 24, 0.26, "[Earth]"),
        new Spell("Boulder Slam"        , 300, 10, 0.18, "[Earth]"),
        new Spell("Mud Slide"           , 200, 25, 0.24, "[Earth]"),
        new Spell("Water Gun"           , 130, 30, 0.23, "[Water]"),
        new Spell("Ice Sword"           , 230, 10, 0.10, "[Water]"),
        new Spell("Aqua Jet"            , 120, 28, 0.15, "[Water]"),
        new Spell("Tsunami"             , 160, 10, 0.03, "[Water]"),
        new Spell("Steam Tornado"       , 250, 20, 0.24, "[Water]"),
        new Spell("Drowning Bubble"     , 350, 10, 0.34, "[Water]"),
        new Spell("Ice Prison"          , 350, 15, 0.40, "[Water]"),
        ...
        new Spell("Cursed Fire"         , 320, 10, 0.21, "[Dark]"),
        new Spell("Zombie Summon"       , 50 , 40, 0.33, "[Dark]"),
        new Spell("Shrouded Punch"      , 300, 10, 0.28, "[Dark]"),
        new Spell("Dark Tornado"        , 150, 32, 0.37, "[Dark]"),
        ...
        new Spell("Blade of Light"      , 200, 27, 0.37, "[Light]"),
        new Spell("Flashlight"          , 100, 22, 0.12, "[Light]"),
        new Spell("Scatter Beam"        , 50 , 42, 0.27, "[Light]")
    };
    ...
    public final static Sword[] swords = {
        ...
        new Sword("Chaos Greatsword"        , 900, 1500)
    };
    ...
    public final static Staff[] staffs = {
        ...
        new Staff("Black Lotus Staff"       , 2.50, 380),
        ...
        new Staff("Black Hole Staff"        , 6.00, 1500)
    };
    ...
    public final static Armor[] armors = {
        ...
        new Armor("Spider Silk Robe"        , 410, 600),
        ...
        new Armor("Sunstone Armor"          , 900, 1500)
    };
    ...
    public final static Enemy[] enemies = {
        ...
        new Enemy("Giant Tarantula"     , 1300, 100, 13, "[Dark]", "[Fire]"  , armors[6])
    };
